...
%% parameters
N=10;
J1=0;J2=5;     % J will change from J1 to J2 linearly in time period [0,tmax-relaxT]
...
theta=pi/2;
psiInit=zeros(Dim,1);
psiInit(nn2k(1,N+1))=1/sqrt(2);
psiInit(nn2k(N+1,1))=1/sqrt(2)*exp(1i*theta);
...
% save to file
save(['..\mats\test\tmax=',num2str(tmax),' theta=',num2str(theta,'%7.1e'),'.mat'],...
    'N','Dim','nn2k','k2nn',...
